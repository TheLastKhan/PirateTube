  ...
  return (
    <div className='play-video'>
      ...
      <div className='play-video-info'>
        <p>{apiData?value_converter(apiData.statistics.viewCount):"10K"} Views &bull; {apiData?moment(apiData.snippet.publishedAt).fromNow():""}
        </p>
        <div>
        <span><img src={like} alt=''/>{apiData?value_converter(apiData.statistics.likeCount):1}</span>
        <span><img src={dislike} alt=''/>{apiData?value_converter(apiData.statistics.dislikeCount):1}</span>
